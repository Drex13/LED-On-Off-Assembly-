...
INICIO:
    ...
    MOVLW 0xF0 ; ((PORTB) and 0FFh), 7, a..((PORTB) and 0FFh), 4, a=1 (entradas), ((PORTB) and 0FFh), 3, a..((PORTB) and 0FFh), 0, a=0 (salidas)
    MOVWF TRISB, A
    BCF INTCON2,7 ; habilita pull-ups en PORTB
    CLRF LATB, A

    CLRF PAUSA, A
    MOVLW 1 ; botón suelto (((PORTB) and 0FFh), 4, a=1 por pull-up)
    MOVWF BOTON_ANT, A
